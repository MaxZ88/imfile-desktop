export default {
  ...
  'aria2-mode-local': 'Local',
  'aria2-mode-remote': 'Remote',
  'rpc': 'RPC',
  'rpc-listen-port': 'RPC Listen Port',
  'rpc-secret': 'RPC Secret',
  'rpc-secret-tips': 'View RPC Secret Manual',
  'remote-rpc': 'Remote RPC',
  'remote-rpc-host': 'Host',
  'remote-rpc-port': 'Port',
  'remote-rpc-path': 'RPC Path',
  'remote-rpc-secure': 'Use TLS (wss/https)',
  'remote-rpc-secret': 'RPC Secret',
  'remote-download-dir': 'Remote Download Dir',
  'remote-mount-path': 'Local Mount Path',
  'developer': 'Developer',
